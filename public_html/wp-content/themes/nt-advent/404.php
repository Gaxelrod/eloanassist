	...
	<?php 
		...
		$nt_advent_error_heading_v 			= 	ot_get_option( 'nt_advent_error_heading_visibility' ); 
		$nt_advent_error_heading 			= 	ot_get_option( 'nt_advent_error_heading' ); 
		$nt_advent_bread_visibility 		= 	ot_get_option( 'nt_advent_bread' ); 
					...
					<div class="row">
						<div class="col-md-8 center">
							<div class="template-cover-intro">
								...
								<?php if ( ( $nt_advent_error_heading_v  ) != 'off') : ?>
									<?php if ( ( $nt_advent_error_heading  ) != 'off') : ?>
										<h2 class="uppercase lead-heading"><?php echo esc_html( $nt_advent_error_heading ); ?></h2> 
									<?php else : ?>
