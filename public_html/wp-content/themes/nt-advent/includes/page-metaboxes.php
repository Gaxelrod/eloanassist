...
$meta_boxes[] = array(
	...
	'fields' => array(
		...
		array(
			'name'		=> 'Select image link type',
			'id'		=> $prefix . "image_link_type",
			'type'		=> 'select',
			'desc'  	=> 'The Default Lightbox option for to enable Lightbox and Custom Link option for your custom URL',
			'options'	=> array(
		...
		array(
			...
			'clone'		=> false,
			'desc'  	=> 'This option is compatible only Custom Link option.Format : http://facebook.com',
			'type'		=> 'text',
			'std'		=> '#'
		),
		...
		array(
			...
			'type'		=> 'select',
			'desc'  	=> 'This option is compatible only Custom Link option',
			'multiple'	=> false,
			'std'		=> '_blank',
			'options'	=> array(
				'_blank'		=> '_blank',
