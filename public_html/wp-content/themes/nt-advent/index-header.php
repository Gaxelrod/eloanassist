			...
			<div class="navbar-header page-scroll">
				...
				<?php if (( $nt_advent_logo_option ) == 'img' ) : ?>
					<?php if ( $nt_advent_img_logo  ) : ?>
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="img-logo navbar-brand page-scroll"><img class="responsive-img" src="<?php echo esc_url( $nt_advent_img_logo ); ?>" alt="<?php esc_html_e( 'Logo', 'nt-advent' ); ?>"></a> <!-- Your Logo -->
						<?php  else : ?>
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="text-logo navbar-brand nav-white page-scroll"><?php esc_html_e( 'Advent', 'nt-advent' ); ?></a> <!-- Your Logo -->
					<?php endif; ?>
				<?php endif; ?>
